...
urlpatterns =[
    path('analyticsCompany/',views.analyticsCompany, name='analyticsCompany'),
    path('analyticsInvestor/',views.analyticsInvestor, name='analyticsInvestor'),
    ...
    #analytics
    path('area-chart', views.area_chart, name="area-chart"),
    path('show-selected', views.show_selected_charts, name='show_selected_charts'),
    path('analytic-index', views.analyticIndex, name="analyticIndex"),
    path('delete/<int:chart_id>/', views.delete_chart, name='delete_chart'),\
